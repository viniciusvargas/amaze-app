...
public class BeaconDetails extends Activity {
    ...
    private static final String serviceUrl = "http://192.168.88.254:9090/amaze-mobile-api/restapi/beacon/identify";
    private static final String imageURI = "http://192.168.88.254:8080/amaze-webapp/";
    ...
    private class DownloadImageTask extends AsyncTask<String, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(String... urls) {
            String urldisplay = imageURI + urls[0];
            Bitmap mIcon11 = null;
            try {
